...
function elevator_gm_house_01_talk(npc, ch) --- NPC für die Netheksäule
	...
	while true do 
		...
		if v == 1 then
		    tmw.chr_warp(ch, 20001, 125 * TILESIZE, DEFAULT_Y_POS) 		
			break;
		elseif v == 2 then
		    tmw.chr_warp(ch, 20002, DEFAULT_X_POS, DEFAULT_Y_POS) 		
			break;
		elseif v == 3 then
		    tmw.chr_warp(ch, 20010, DEFAULT_X_POS, DEFAULT_Y_POS) 		
			break;
		elseif v == 4 then
		    tmw.chr_warp(ch, 20011, DEFAULT_X_POS, DEFAULT_Y_POS) 		
			break;
		elseif v == 5 then
