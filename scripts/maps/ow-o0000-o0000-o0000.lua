...
function julia_talk(npc, ch)
	...
	while true do 
		...
		if v == 1 then
			mana.npc_trade(npc, ch, false, { {10001, 10, 20}, {10013, 10, 160}, {10002, 10, 1495}, {20001, 10, 30}, {20002, 10, 50}, {20011, 10, 30}, 
{20012, 10, 
30}, 
{20013, 10, 30}, {20014, 10, 30}, {20015, 10, 50}, {20016, 10, 50}, {20017, 10, 50}, {20018, 10, 50}  })
			break
		elseif v == 2 then
