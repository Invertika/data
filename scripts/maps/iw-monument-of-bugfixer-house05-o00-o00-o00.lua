...
function umach_talk(npc, ch)
    ...
    elseif quest_var_flower == 1 and quest_var_kill == 0 then
        ...
        do_message(npc, ch, "Wir sind hier nie herausgegangen, da unsere Vorfahren dem Fehlerbeheber einen Eid geleistet haben.")
        ...
        do_message(npc, ch, "Als wir versuchten, das Tageslicht zu erblicken, sahen wir, dass der Eingang verschüttet war.")
        do_message(npc, ch, "Monster haben die äußere Höhle in ihren Besitz genommen.")
