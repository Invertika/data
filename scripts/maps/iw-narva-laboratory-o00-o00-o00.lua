...
atinit(function()
    ...
    nalaf = create_npc("Nalaf", 11, 41 * TILESIZE + 16, 35 * TILESIZE + 16, nalaf_talk, nil)
    ...
    warves = create_npc("Warves", 7, 45 * TILESIZE + 16, 38 * TILESIZE + 16, warves_talk, nil)
    ...
    if get_qstatus() == 0 then
        ...
        while true do
            ...
            if v == 1 then
                ...
                do_message(npc, ch, "Wenn du dir ein paar Münzen dazu verdienen willst kannst du ein paar dieser Körper besorgen.")
                while true do
